                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                          <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                                                            <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                                <h1 style="text-align:left; margin-top: 10px; margin-bottom: 10px; font-weight: normal;"><span style="line-height:41px;letter-spacing:normal;font-size:24px;font-family:Arial;color:#000000;text-align:left;"><b>Réinitialiser votre mot de passe</b></span></h1>
                                                            </div>
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                      ...
                                                      <tr>
                                                          <td align="center" vertical-align="middle" style="font-size:0px;padding:20px 25px 20px 25px;padding-top:20px;padding-right:25px;padding-bottom:20px;padding-left:25px;word-break:break-word;">
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:100%;line-height:100%;">
                                                                <tbody>
                                                                  <tr>
                                                                      <td align="center" bgcolor="#fb0030" role="presentation" style="border:none;border-radius:30px;cursor:auto;mso-padding-alt:15px 25px 15px 25px;background:#fb0030;" valign="middle"><a href="${link}" style="display:inline-block;background:#fb0030;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:15px 25px 15px 25px;mso-padding-alt:0px;border-radius:30px;" target="_blank"><span style="font-size:16px;font-family:Arial;color:#ffffff;background-color:#fb0030;text-align:center;">Réinitialiser mon mot de passe</span></a></td>
                                                                  </tr>
                                                                </tbody>
                                                            </table>
                                                          </td>
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                                            <p style="text-align: center; margin: 10px 0; margin-top: 10px; margin-bottom: 10px;"><span style="text-align:center;line-height:22px;font-size:16px;">Cet email a été envoyé à ${fullName}, <a href="${link}" style="color:inherit;text-decoration:none;" target="_blank">cliquez ici pour vous désabonner</a>.</span></p>
                                                                        </div>
                                                                      </td>
                                                                  </tr>
                                                                  <tr>
